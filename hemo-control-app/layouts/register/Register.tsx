...
export const Register: FC<RegisterProps> = ({ onRegister }) => {
    ...
    return <>
        <Container>
            <Input placeholder="Nome" autoCompleteType="name" onChangeText={setName} />
            <Input placeholder="Email" autoCompleteType="email" onChangeText={setEmail} />
            ...
            <LoginButton onPress={() => onRegister({ name, email, username, password })}>
